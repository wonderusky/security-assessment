...
<body>
    ...
    <div class="page">
        ...
        ${renderFindingCard(2, 'Nation-state actors are actively targeting your infrastructure.', "Analysis of inbound sessions confirms active targeting from hostile nation-states, including China, Russia, and Iran. This includes the detection of BPFDoor—a stealthy Linux backdoor attributed to Chinese state-sponsored actors (Red Menshen). This directly triggers ITAR and CMMC IR.2.093 incident reporting protocols.")}
        ${renderFindingCard(3, 'You are completely blind to 33.6 TB of high-risk traffic.', 'SSL and encrypted-tunnel applications account for 26.8% of your entire network traffic. Without SSL decryption enabled on the firewall, attackers can exfiltrate intellectual property or communicate with C2 servers completely undetected.')}
